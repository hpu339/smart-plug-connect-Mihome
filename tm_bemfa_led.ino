...
#define wifi_name  "TP-LINK_49AF"     //WIFI名称，区分大小写，不要写错
#define wifi_password   "xiaomi"  //WIFI密码
String UID = "4f4d7f9f050*******e1033bf4";  //用户私钥，可在控制台获取,修改为自己的UID
String TOPIC = "light001";         //主题名字，可在控制台新建
const int LED_Pin = 12;              //单片机LED引脚值，D2是NodeMcu引脚命名方式，其他esp8266型号将D2改为自己的引脚
const int plug = 5;
const int button = 4;
boolean buttonStatue = true;
String upUrl = "http://bin.bemfa.com/b/3Bc*************MzNiZjQ=light001.bin";//固件链接，在巴法云控制台复制、粘贴到这里即可
